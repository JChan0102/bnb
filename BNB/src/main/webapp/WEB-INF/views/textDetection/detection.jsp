...
<c:choose>
    <c:when test="${sessionScope.loginUser.host eq 2}">
        <div class="row justify-content-center" style="padding-top: 50px;">
            <div class="col-md-6">
                <h1 style="color:darkred; text-align: center; font-size: 5em; padding-bottom: 35px"><i class="fas fa-exclamation-triangle"></i></h1>
                <h4 style="line-height:35px; text-align: center">
                        " ${sessionScope.loginUser.userName} "님은 호스트 신청이 불가능한 상태입니다.<br> 관리자에게 문의해주세요.
    ...
    <c:otherwise>
        ...
        <div id="left_div" style="margin-left: 50px;">
        ...
        <script type="text/javascript">
            ...
            function readURL(input) {
                $('#img').remove();
                $('#results').text('');
                $('#results').html('<button style="margin-top : 20px" id="hostSubmit">호스트 신청하기</button>');
