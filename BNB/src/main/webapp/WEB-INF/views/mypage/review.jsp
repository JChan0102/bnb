...
<body style="background-color: #EEEEEE;">
	...
	<div id="mypage_wrap_cont">
		...
		<ul class="nav reviewNav">
				...
				<li style="margin-left: 335px;"><li>
					<form class="form-inline my-2 my-lg-0" method="get" id="searchForm" action="${pageContext.request.contextPath }/reviewSearchList" >
						...
						<button class="btn my-2 my-sm-0" id="searchBtn" style="background-color: #FF5675; color: white;">검색</button>
					</form></li>
			</ul>	
			<form id="actionForm" action="/mypage/reviewSearchList" method="get">
				<input type="hidden" name="searchType" value='<c:out value="${rvs.searchType}" />'>
				<input type="hidden" name="keyword" value='<c:out value="${rvs.keyword}" />'>
			</form>
			<div id="review_cont">
				<!-- 써야할 리뷰 리스트 -->
