	...
	<div id="mypage_wrap_cont">
		...
		<div id="mypage_cont">
			...
			<ul class="nav reviewNav">
				<li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath }/review">내가 쓴 후기</a></li>
				...
				<c:if test="${reviewTo ne null}">
					<c:forEach var="reTo" items="${reviewTo}">
						<table id="review_table" rules="none" style="border-radius: 10px;">
							<tr>
								<td class="review_photo" rowspan='2'><img src="${pageContext.request.contextPath}/resources/images/짱짱절미.jpg" id="review_img"> ${reTo.userPhoto}</td>
								<td class="review_host">${reTo.hostId}님의 대한 후기</td>
