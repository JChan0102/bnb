    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
            ...
            <body class="umkibody">
                <div class="wrapperr">
                    <div id="show">
                        <div id="showpri"><i class="fas fa-won-sign"></i>
                            <fmt:formatNumber value="${selectedRoom.price_weekdays}" pattern="###,###,###" />
                        </div>
                ...
                <script>
                    ...
                    var little = 0;
                    var limit = $ {
                        selectedRoom.avail_adults + selectedRoom.avail_children
                    };
