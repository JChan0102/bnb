        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="nav justify-content-end ml-auto">
                ...
                <c:if test="${loginUser ne null}">
                    <li class="nav-item"><a class="nav-link text-dark" href="${pageContext.request.contextPath}/logout">로그아웃</a>
                    </li>
                    ...
                    <li class="nav-item text-dark dropdown">
                        <a class="nav-link  dropdown-toggle" href="#" id="navbarDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            알림<span class="badge badge-secondary" id="jchannotice"><c:if test="${sessionScope.NewmessageCk ne 0}">new</c:if></span>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/chat/list">더보기..</a>
                        </div>
                    </li>
                    <li class="nav-item"><a class="nav-link text-dark"
...
<script type="text/javascript">
    ...
    function connect() {
        ...
        sockg.onmessage = function (evt) {
            ...
            if((obj.userId == '${sessionScope.loginUser.userId}' && obj.receive=='U') ||(obj.hostId == '${sessionScope.loginUser.userId}' && obj.receive=='H')){
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="${pageContext.request.contextPath}/login" method="post">
                    아이디 : <input type="text" name="userId" placeholder="example@example.com"
                                 value="${cookie.cookieUserId.value}"/> <br>
